...
namespace prjFinal.Models
{
    ...
    public partial class DogsEntities : DbContext
    {
        ...
        {
            var originalConnectionString = ConfigurationManager.ConnectionStrings["DogsEntities"].ConnectionString;//修改Entities名稱
        ...
        public virtual DbSet<Table流浪狗s1091722> Table流浪狗s1091722 { get; set; }
    }
}
